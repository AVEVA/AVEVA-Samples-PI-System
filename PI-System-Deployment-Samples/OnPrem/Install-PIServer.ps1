...
.SYNOPSIS
    ...
    TODO: Remove references to Emerson/ACH/DeltaV Connector throughout this summary
...
.PARAMETER SQLInstanceName
    TODO: Remove: for sample, SQL Express should use default instance name
...
.PARAMETER updatesOnly
    TODO: Likely can remove this parameter
...
#
param(
        # TODO: Consider a 'dryRun' parameter where we log but do not actually install
        # TODO: Need parameter for PI Server install kit
		[string]$pilicense = "",                       # location of license file to use
        # TODO: Verify value SQLExpress is correct
        [string]$SQLInstanceName = "SQLExpress",       # default SQL Server Instance
...
# TODO: This is used for the directory for log files. Change name and value of this parameter.
# TODO: Consider adding timestamp or kit file name to log folder name
# TODO: Consider file directory like "Timestamp\Logs, TimeStamp\Install" instead of sibling folders
...
#
$myLogFileDir = (Get-Item $env:TEMP).FullName + $piserver_version + "_Install_ExecutionOuputLog"c
...
# TODO: Eliminate this logic, assume 'script files' are already local
...
# TODO: Try using something like "if x OR y then..."
...
# TODO: Move bitness/OS checks as early as possible
...
# TODO: Convert this into a parameter, allow passing D:\, default to C:\
...
# TODO: Try using something like "if x OR y then..."
# TODO: Consider using helper function
