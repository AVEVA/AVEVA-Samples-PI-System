...
$DeploySampleModules = 'cNtfsAccessControl_1.4.1.zip', 'xAdcsDeployment_1.4.zip', 'xNetworking_5.7.zip', 'xSmbShare_2.1.zip', 'AWSQuickStart.zip', 'PISecurityDSC_2.2.0.2.zip', 'SqlServerDsc_13.2.zip', 'xComputerManagement_4.1.zip', 'cChoco_2.4.zip', 'xStorage_3.4.zip', 'SqlServer_21.0.17279.zip', 'xDnsServer_1.15.zip', 'xPendingReboot_0.4.zip', 'xWebAdministration_2.8.zip', 'cHostedPI_1.0.zip', 'xActiveDirectory_3.0.zip', 'xRemoteDesktopSessionHost_1.9.zip'
#endregion
