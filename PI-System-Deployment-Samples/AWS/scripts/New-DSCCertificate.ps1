try {
    ...
    <#region CREATE SELF SIGNED CERT FOR DSC FUNCTION#>    
    # Script comes from https://gallery.technet.microsoft.com/scriptcenter/Self-signed-certificate-5920a7c6
    # If using Windows Server 2016, can simply use built in cmdlet: $cert = New-SelfSignedCertificate -Type DocumentEncryptionCertLegacyCsp -DnsName 'DscEncryptionCert' -HashAlgorithm SHA256
    ...
    <#endregion CREATE SELF SIGNED CERT FOR DSC FUNCTION#>


    <#region GENERATE DSC CERTIFICATE#>
    # Certificate settings used for DSC. Key component is that the certificate EKU is Document Encryption.
    $certSettings = @{
    ...
    # Create certificate
    New-SelfsignedCertificateEx -Exportable @certSettings
    ...
    Export-Certificate -Cert $cert -FilePath 'c:\dsc.cer' -ErrorAction Stop
    <#endregion GENERATE DSC CERTIFICATE#>
